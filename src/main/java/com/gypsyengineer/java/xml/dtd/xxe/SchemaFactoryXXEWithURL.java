...
public class SchemaFactoryXXEWithURL {
    ...
    public static void main(String... args) throws Exception {
        ...
        try {
            ...
            /*
             * Enabling XMLConstants.FEATURE_SECURE_PROCESSING fixes the issue:
             *
            ...
            server.close();
            if (server.accepted()) {
                throw new RuntimeException("Oops! Accepted!");
            }
        }
    }

    private static class SimpleHttpServer implements HttpHandler, AutoCloseable {
        ...
        SimpleHttpServer(String content) throws IOException {
